...
public class ANDSearch {
    ...
    @Getter @Setter private ANDQueryGenerator queryGenerator;

    public ANDSearch(Class entityType, String query) {
        this.query = query;
        this.entityType = entityType;
        this.queryGenerator = new ANDQueryGenerator(entityType);
    ...
    public ANDSearch(Class entityType){this(entityType,"");}
    ...
    public ANDSearch setQuery(String query) {
        this.query = query;
        indexTerms();
        return this;
    }
