...
public class TestQueryGenerator {
    ...
    public void TestBooleanQuery(){
        ...
        assertEquals(q11,"from Challenge where challengeId like '%a%' or dateCreated like '%a%' or dateLastModified like '%a%' or question like '%a%' or answer like '%a%' or lastAuthor like '%a%' or author like '%a%' or enabled like '%a%' or (challengeId like '%b\"%' and challengeId like '%c%') or (dateCreated like '%b\"%' and dateCreated like '%c%') or (dateLastModified like '%b\"%' and dateLastModified like '%c%') or (question like '%b\"%' and question like '%c%') or (answer like '%b\"%' and answer like '%c%') or (lastAuthor like '%b\"%' and lastAuthor like '%c%') or (author like '%b\"%' and author like '%c%') or (enabled like '%b\"%' and enabled like '%c%') or (challengeId like '%p%' and challengeId like '%d%') or (dateCreated like '%p%' and dateCreated like '%d%') or (dateLastModified like '%p%' and dateLastModified like '%d%') or (question like '%p%' and question like '%d%') or (answer like '%p%' and answer like '%d%') or (lastAuthor like '%p%' and lastAuthor like '%d%') or (author like '%p%' and author like '%d%') or (enabled like '%p%' and enabled like '%d%')");
        assertEquals(q12,"from Challenge where challengeId like '%f%' or dateCreated like '%f%' or dateLastModified like '%f%' or question like '%f%' or answer like '%f%' or lastAuthor like '%f%' or author like '%f%' or enabled like '%f%' or (challengeId like '%a%' and challengeId like '%c%') or (dateCreated like '%a%' and dateCreated like '%c%') or (dateLastModified like '%a%' and dateLastModified like '%c%') or (question like '%a%' and question like '%c%') or (answer like '%a%' and answer like '%c%') or (lastAuthor like '%a%' and lastAuthor like '%c%') or (author like '%a%' and author like '%c%') or (enabled like '%a%' and enabled like '%c%') or (challengeId like '%p%' and challengeId like '%d%') or (dateCreated like '%p%' and dateCreated like '%d%') or (dateLastModified like '%p%' and dateLastModified like '%d%') or (question like '%p%' and question like '%d%') or (answer like '%p%' and answer like '%d%') or (lastAuthor like '%p%' and lastAuthor like '%d%') or (author like '%p%' and author like '%d%') or (enabled like '%p%' and enabled like '%d%')");
    ...
    public void TestInvalidSearches(){
        ...
        assertEquals(q5,"from Challenge where challengeId like '%question=%' or dateCreated like '%question=%' or dateLastModified like '%question=%' or question like '%question=%' or answer like '%question=%' or lastAuthor like '%question=%' or author like '%question=%' or enabled like '%question=%'");
        assertEquals(q6,"from Challenge where challengeId like '%=question=%' or dateCreated like '%=question=%' or dateLastModified like '%=question=%' or question like '%=question=%' or answer like '%=question=%' or lastAuthor like '%=question=%' or author like '%=question=%' or enabled like '%=question=%'");
        assertEquals(q7,"from Challenge where challengeId like '%= abc%' or dateCreated like '%= abc%' or dateLastModified like '%= abc%' or question like '%= abc%' or answer like '%= abc%' or lastAuthor like '%= abc%' or author like '%= abc%' or enabled like '%= abc%'");
        assertEquals(q8,"from Challenge where challengeId like '%answer%' or dateCreated like '%answer%' or dateLastModified like '%answer%' or question like '%answer%' or answer like '%answer%' or lastAuthor like '%answer%' or author like '%answer%' or enabled like '%answer%'");
        assertEquals(q9,"from Challenge");
        assertEquals(q10,"from Challenge where challengeId like '%\"%' or dateCreated like '%\"%' or dateLastModified like '%\"%' or question like '%\"%' or answer like '%\"%' or lastAuthor like '%\"%' or author like '%\"%' or enabled like '%\"%'");
        assertEquals(q11,"from Challenge where challengeId like '%=%' or dateCreated like '%=%' or dateLastModified like '%=%' or question like '%=%' or answer like '%=%' or lastAuthor like '%=%' or author like '%=%' or enabled like '%=%'");
        assertEquals(q12,"from Challenge where challengeId like '%~!@#$%^&*()_+{}|:?><,./';[]\\=-*/+-%' or dateCreated like '%~!@#$%^&*()_+{}|:?><,./';[]\\=-*/+-%' or dateLastModified like '%~!@#$%^&*()_+{}|:?><,./';[]\\=-*/+-%' or question like '%~!@#$%^&*()_+{}|:?><,./';[]\\=-*/+-%' or answer like '%~!@#$%^&*()_+{}|:?><,./';[]\\=-*/+-%' or lastAuthor like '%~!@#$%^&*()_+{}|:?><,./';[]\\=-*/+-%' or author like '%~!@#$%^&*()_+{}|:?><,./';[]\\=-*/+-%' or enabled like '%~!@#$%^&*()_+{}|:?><,./';[]\\=-*/+-%'");
